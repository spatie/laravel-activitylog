 ...
 * @method static \Spatie\Activitylog\ActivityLogger event(string|\BackedEnum|\UnitEnum $event)
 * @method static \Spatie\Activitylog\ActivityLogger setEvent(string|\BackedEnum|\UnitEnum $event)
