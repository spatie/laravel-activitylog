...
- Drop php 7 support.
- Add Activity batches [#560](https://github.com/spatie/laravel-activitylog/issues/560)
- Add Pipelines.
...
- Causer Resolver to define causer for runtime [#582](https://github.com/spatie/laravel-activitylog/issues/582).
